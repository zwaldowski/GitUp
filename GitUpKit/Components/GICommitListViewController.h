...
@property(nonatomic, copy) NSArray<__kindof id<GCHistoryItem>>* results;  // Can contain GCHistoryCommit, GCHistoryLocalBranch, GCHistoryRemoteBranch or GCHistoryTag
@property(nonatomic, readonly) NSArray<GCHistoryCommit*>* commits;  // Converted results to GCHistoryCommits
@property(nonatomic, assign) __kindof id<GCHistoryItem> selectedResult;
