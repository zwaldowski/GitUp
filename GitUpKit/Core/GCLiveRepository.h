...
- (NSArray<__kindof id<GCHistoryItem>>*)findCommitsMatching:(NSString*)match;  // Returns GCHistoryCommit, GCHistoryLocalBranch, GCHistoryRemoteBranch or GCHistoryTag (references are guaranteed to have a corresponding commit)
@end
