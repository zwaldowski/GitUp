...
@class GCSearchIndex, GCSnapshot, GCHistoryCommit, GCHistoryLocalBranch, GCHistoryRemoteBranch, GCHistoryTag;

@protocol GCHistoryItem <NSObject>
@property(nonatomic, readonly) GCRepository* repository;
@end

@interface GCHistoryCommit : GCCommit <GCHistoryItem>
...
@interface GCHistoryTag : GCTag <GCHistoryItem>
...
@interface GCHistoryLocalBranch : GCLocalBranch <GCHistoryItem>
...
@interface GCHistoryRemoteBranch : GCRemoteBranch <GCHistoryItem>
@property(nonatomic, readonly) GCHistoryCommit* tipCommit;  // Cached at time of last history update and DOES NOT automatically update (use -lookupTipCommitForBranch:error: instead)
@end
